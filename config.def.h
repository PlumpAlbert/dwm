...
static const char *fonts[]          = {
  "Space Mono:pixelsize=10:antialias=true:autohint=true",
...
static char dmenufont[]             = "JetBrainsMono Nerd Font:pixelsize=10";
...
static const Rule rules[] = {
	...
	*/
	/* class    instance      title       	 tags mask    isfloating   isterminal  noswallow xkb_layout monitor */
	{ "Gimp",     NULL,       NULL,       	    1 << 8,       0,           0,         0,         0,        -1 },
	{ "RescueTime",NULL,      NULL,       	    0,            1,           0,         1,         0,        -1 },
	{ "St",       NULL,       NULL,       	    0,            0,           1,         0,         0,        -1 },
	{ "firefox",  NULL,       NULL,       	    0,            0,           1,         1,        -1,        -1 },
	{ "Google-chrome",  NULL, NULL,       	    0,            0,           1,         1,        -1,        -1 },
	{ "Telegram", NULL,       NULL,       	    0,            0,           1,         1,         1,        -1 },
	{ "Discord",  NULL,       NULL,       	    0,            0,           1,         1,        -1,        -1 },
	{ NULL,       NULL,       "Event Tester",   0,            0,           0,         1,        -1,        -1 },
	{ NULL,      "spterm",    NULL,       	    SPTAG(0),     1,           1,         0,        -1,        -1 },
	{ NULL,      "spcalc",    NULL,       	    SPTAG(1),     1,           1,         0,        -1,        -1 },
	{ "lxqt-openssh-askpass", NULL,    NULL,    0,            1,           1,         0,         0,        -1 },
	{ "TelegramDesktop", NULL,    " ",          0,            1,           0,         1,         0,        -1 },
};
...
static Key keys[] = {
  ...
  /* { MODKEY|ShiftMask,		XK_Tab,		spawn,		SHCMD("") }, */
	...
	{ Mod4Mask,		XK_space,	spawn,		SHCMD("rofi_run") },
	...
	{ MODKEY|ShiftMask,		XK_r,	spawn,		SHCMD("record kill") },
	...
	{ 0, XF86XK_PowerOff,		spawn,		SHCMD("rofi_run -l") },
	{ 0, XF86XK_Calculator,		spawn,		SHCMD("st -e bc -l") },
	{ 0, XF86XK_WWW,		spawn,		SHCMD("$BROWSER") },
	{ 0, XF86XK_DOS,		spawn,		SHCMD("st") },
	{ 0, XF86XK_TaskPane,		spawn,		SHCMD("st -e htop") },
	{ 0, XF86XK_MyComputer,		spawn,		SHCMD("pcmanfm-qt") },
...
static Button buttons[] = {
	...
	{ ClkStatusText,        ShiftMask,      Button3,        spawn,          SHCMD("st -e nvim ~/sources/blocks/config.h") },
