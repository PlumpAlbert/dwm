...
static char dmenufont[]             = "SF Mono:pixelsize=10";
...
const char *spcmd2[] = {"st", "-n", "spcalc", "-f", "SF Mono:pixelsize=10", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "RescueTime",NULL,      NULL,       	    0,            1,           0,         0,         0        -1 },
	{ "St",       NULL,       NULL,       	    0,            0,           1,         0,         0        -1 },
	{ "firefox",  NULL,       NULL,       	    0,            0,           1,         0,        -1        -1 },
	{ "Google-chrome",  NULL, NULL,       	    0,            0,           1,         0,        -1        -1 },
	{ "Telegram", NULL,       NULL,       	    0,            0,           1,         0,         1        -1 },
	{ "Discord",  NULL,       NULL,       	    0,            0,           1,         0,        -1        -1 },
...
static Key keys[] = {
  ...
  /* System shortcuts */
	...
	{ SUPER,		          XK_space,	    spawn,		    SHCMD("rofi_run") },
	{ MODKEY|ShiftMask,		XK_w,		      spawn,		    SHCMD("st -e sudo nmtui") },
	{ MODKEY,		        	XK_w,		      spawn,		    SHCMD("$BROWSER") },
	{ CTRL|SHIFT,		      XK_Escape,		spawn,		    SHCMD("st -e htop") },
