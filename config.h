...
static const char *fonts[]          = {
  ...
  "EmojiOne:size=8:antialias=true:autohint=true",
  "FontAwesome:size=8:antialias=true:autohint=true",
  "Font Awesome 5 Free:size=8:antialias=true:autohint=true",
  "Font Awesome 5 Brands:size=8:antialias=true:autohint=true",
};
static char dmenufont[]             = "JetBrainsMono Nerd Font:size=8";
